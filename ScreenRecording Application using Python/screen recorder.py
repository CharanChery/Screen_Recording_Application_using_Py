...
try:
    ...
    video_output_data = cv2.VideoWriter(
        "ScreenRecord_20_fps.mp4", format, 20.0, dimension)
    ...
    Duration = int(input("Enter the duration time to record the video:"))
    ...
    finish_time = Present_time + Duration + Duration
    ...
    print("Video recording cancelled", KeyboardInterruptted())
